...
const Address = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8081/api/district')
            .then(function (response) {
    ...
    const deleteFunc = (id) => {
        ...
        setAddress(address)
        axios.delete('http://localhost:8081/api/address/' + id)
            .then(function (response) {
    ...
    const [responseAddress, setResponseAddress] = useState(
        {
            userId: "e4db33a3-7b82-4548-abe5-0f78dc406200",
            name: "",
            districtId: "",
            landmark: "",
            houseNumber: "",
...
//Todo hozircha districtId hard code
    ...
    const addAddress = () => {
        axios.post('http://localhost:8081/api/address', {
                userId: "e4db33a3-7b82-4548-abe5-0f78dc406200",
        ...
        Cancel
            ...
            {address.map((a, i) => (
                    ...
                    <div key={i} className="my-12 max-w-screen-xl mx-auto px-6 justify-content-between flex flex-wrap ">
                        ...
                        <div className="bg-white border border-gray-100   duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg ">
